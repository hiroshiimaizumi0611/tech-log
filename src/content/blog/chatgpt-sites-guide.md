...
ChatGPT Sitesでは、指示からWebサイトを作り、ホストし、会話で修正して共有まで進められます。ただし、デプロイされたURLは本番です。まずバージョンを保存し、内容と共有範囲を確認してから公開へ進むのが安全です。今回の実演では、最も狭い「自分のみ」を維持した状態で、未認証ユーザーから開けないことまで確認しました。
